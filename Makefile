...
AOBJS=		QSufSort.o bwt_gen.o bwase.o bwaseqio.o bwtgap.o bwtaln.o bwtalnpe.o bwtalnse.o bamlite.o \
			is.o bwtindex.o bwape.o kopen.o pemerge.o \
			bwtsw2_core.o bwtsw2_main.o bwtsw2_aux.o bwt_lite.o \
			bwtsw2_chain.o fastmap.o bwtsw2_pair.o
PROG=		bwa-0.7.10-streaming
INCLUDES=	
LIBS=		-lm -lz -lpthread
SUBDIRS=	.
...
bwa-0.7.10-streaming:libbwa.a $(AOBJS) main.o
