...
//
//    } else{
//        filter((w->n_processed>>1) + i, &w->seqs[i<<1]);
//    }
//
//}
...
//	kt_for(opt->n_threads, worker0, &w, (opt->flag&MEM_F_PE)? n>>1 : n); // filter reads
